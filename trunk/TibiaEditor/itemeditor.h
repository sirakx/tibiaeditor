...
public:
	...
	TibiaItem* getTibiaItem( void ) const { return m_tibiaItem; };
	QUndoStack* getUndoStack( void ) const { return m_undoStack; };

	QSpinBox* getWidth( void ) const { return ui->viewAttributeWidth; };
	QSpinBox* getHeight( void ) const { return ui->viewAttributeHeight; };
	QSpinBox* getCropsize( void ) const { return ui->viewAttributeCropsize; };
	QSpinBox* getLayers( void ) const { return ui->viewAttributeLayers; };
	QSpinBox* getXDiv( void ) const { return ui->viewAttributeXDiv; };
	QSpinBox* getYDiv( void ) const { return ui->viewAttributeYDiv; };
	QSpinBox* getZDiv( void ) const { return ui->viewAttributeZDiv; };
	QSpinBox* getAnimations( void ) const { return ui->viewAttributeAnimations; };
	ItemAttributes* getItemAttributes( void ) const { return ui->itemAttributes; };
