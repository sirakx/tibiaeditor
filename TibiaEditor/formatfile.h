...
public:
	...
	virtual bool isLoaded( void ) const { return _loaded; };
	...
	inline FormatMap::const_iterator getFormatsIteratorBegin() const { return formats.begin(); }
	inline FormatMap::const_iterator getFormatsIteratorEnd() const { return formats.end(); }
