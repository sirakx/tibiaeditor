...
public:
	...
	quint32 getCount( void ) const { return m_count; };
	void setVersion( quint16 version ) { m_version = version; };
	quint16 getVersion( void ) const { return m_version; };
	quint32 getItemsSize( void ) const { return m_items.size(); };
	bool mustIdle( void ) const { return m_mustIdle; };
