...
void TibiaEditor::onFileError( QString preset, QFile::FileError error )
{
	...
	switch( error )
	{
		case QFile::ReadError:			errorString = tr( "An error occurred when reading from the file." );	break;
		case QFile::WriteError:			errorString = tr( "An error occurred when writing to the file." );		break;
		case QFile::FatalError:			errorString = tr( "A fatal error occurred." );							break;
		case QFile::ResourceError:		errorString = tr( "A resource error occured." );						break;
		case QFile::OpenError:			errorString = tr( "The file could not be opened." );					break;
		case QFile::AbortError:			errorString = tr( "The operation was aborted." );						break;
		case QFile::TimeOutError:		errorString = tr( "A timeout occurred." );								break;
		case QFile::UnspecifiedError:	errorString = tr( "An unspecified error occurred." );					break;
		case QFile::RemoveError:		errorString = tr( "The file could not be removed." );					break;
		case QFile::RenameError:		errorString = tr( "The file could not be renamed." );					break;
		case QFile::PositionError:		errorString = tr( "The position in the file could not be changed." );	break;
		case QFile::ResizeError:		errorString = tr( "The file could not be resized." );					break;
		case QFile::PermissionsError:	errorString = tr( "The file could not be accessed." );					break;
		case QFile::CopyError:			errorString = tr( "The file could not be copied." );					break;
	}
